...
<section class="main">
		...
		<div class="main-right">
			<div class="main-header-chalenge">
				<p class="chalenge-titel">Создать челендж</p>
			</div>
			<div class="orange-line"></div>
			<!-- /.main-header-chalenge -->
			<section class="section_chls_create_block">
				<form action="#" class="reg-form" method="POST">
					<div class="block_inp_or">
						<p class="inp_left_cont">Название челенджа</p>
						<input name="nameOfChl"></input> <br>
					</div>
					<div class="block_inp_or">
						<p class="inp_left_cont about">Описание</p>
						<textarea  name="discrOfChl" class="discr_inp_chl"></textarea>
					</div>

					<input name="submit" type="submit" value="Создать" class="but-save_or">	
				</form>
			</section>
